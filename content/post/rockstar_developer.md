...
1. **Hold them accountable:** The hardest piece of advice first, but if you can somehow help them understand that their actions are harmful to the team and not allowing other developers to learn, grow, and deliver you will have gone a long way in solving the issue.
2. **Force Documentation and Understanding**: This often equates to forcing the Rockstar to _slow down_. Oftentimes they're moving so fast that no one knows what's going on, being written, or being accomplished but them. Make an effort to push for documentation, knowledge sharing sessions, and *gasp* pair programming sessions if need be.
3. **Share the Cognitive Load:** If you can, you need to make the Rockstar share the burden they're carrying alone. Remember that they're usually not bad or arrogant people - and they're trying to do what's best for the business.  Your mileage may vary here, and each person is different so I can't give you more advice than a general push to make the Rockstar see you as a someone who can help.
4. **Unify the Team:** If the Rockstar is too busy delivering, and management all too happy with the status quo, it will be up to you to gather and unify the team. You'll need to become a competent Sous Chef - willing and able to pull from the Rockstar's plate, but succeeding where they fail by then delegating to your team

#### Advice for being a Rockstar Developer
1. **Your ultimate goal should be to stop being a Rockstar**: Every action you should be taken from the time you realize you're in this position until the end of your tenure should be in service of spreading the load and building your software kitchen in order to make this a thing of the past.
